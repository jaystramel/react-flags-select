...
var ReactFlagsSelect = function (_Component) {
	...
	function ReactFlagsSelect(props) {
		...
		_this.selectedFlag = _react2.default.createRef();
		_this.flagOptions = _react2.default.createRef();
		_this.filterText = _react2.default.createRef();
		return _this;
	}
	...
	ReactFlagsSelect.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ ref: this.selectedFlag, style: { fontSize: selectedSize + 'px' }, className: 'selected--flag--option ' + (this.props.disabled ? 'no--focus' : ''), tabIndex: '0', onClick: this.toggleOptions, onKeyUp: function onKeyUp(evt) {
			...
			this.state.openOptions && _react2.default.createElement(
				'div',
				{ ref: this.flagOptions, style: { fontSize: optionsSize + 'px' }, className: 'flag-options ' + alignClass },
				this.props.searchable && _react2.default.createElement(
					'div',
					{ className: 'filterBox' },
					_react2.default.createElement('input', { type: 'text', placeholder: this.props.searchPlaceholder, ref: this.filterText, onChange: this.filterSearch })
				),
